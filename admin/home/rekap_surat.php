<?php 
  ...
  $data = mysqli_query($conn, "SELECT surat.id_surat, surat.id_surat_detail, surat.id_iduka, files, tgl_surat, surat_detail.surat, iduka.iduka
  FROM surat
  JOIN surat_detail ON surat.id_surat_detail = surat_detail.id_surat_detail
  JOIN iduka ON surat.id_iduka = iduka.id_iduka
  WHERE surat.id_surat_detail = '2'
  ORDER BY tgl_surat ASC");
?>
<section class="content-header">
  <h1> Rekap Surat Tugas </h1>
</section>
<!-- Main content -->
<section class="content">
  <a href="surat_tugas.php" type="button" class="btn btn-danger btn-sm ">
    <i class="fa fa-plus-square"></i> Buat Surat Tugas</a>
  <p></p>
  <!-- Default box -->
          ...
          <?php foreach ($data as $key => $value) { ?>
            <tr>
              ...
              <td class="text-center">
                <a href="lihat_surat.php?id=<?php echo $value['id_surat']; ?>"><img src="assets/img/folder.png" width="30px" height="30px" alt="" data-toggle="tooltip" data-placement="bottom" title="LIHAT SURAT"></a>
              </td>
              <td class="text-center">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-sm btn-default pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close
              <a href="api/surat/hapus_surat.php?id=<?php echo $value['id_surat']; ?>&&files=<?php echo $value['files']; ?>">

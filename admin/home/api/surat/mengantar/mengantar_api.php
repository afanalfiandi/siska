...
file_put_contents('../../../../../files/pkl/surat/mengantar/' . $nama_file, $output);
$sql = mysqli_query($conn, "INSERT INTO 
surat(id_surat_detail, id_iduka, no_surat, tgl_surat, files) 
VALUES('3', '$iduka', '$no_surat', '$tgl_surat', '$nama_file')");
?>
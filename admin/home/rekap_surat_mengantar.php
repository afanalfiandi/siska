<?php 
  ...
  WHERE surat.id_surat_detail ='3'
  ORDER BY tgl_surat ASC");
?>
<section class="content-header">
  <h1> Rekap Surat Mengantar </h1>
</section>
<!-- Main content -->
<section class="content">
  <a href="surat_mengantar.php" type="button" class="btn btn-danger btn-sm ">
    <i class="fa fa-plus-square"></i> Buat Surat Mengantar</a>
  <p></p>
  <!-- Default box -->
          ...
          <?php foreach ($data as $key => $value) { ?>
            <tr>
              ...
              <td class="text-center">
                <a href="lihat_surat_pengantar.php?id=<?php echo $value['id_surat']; ?>"><img src="assets/img/folder.png" width="30px" height="30px" alt="" data-toggle="tooltip" data-placement="bottom" title="LIHAT SURAT"></a>
              </td>
              <td class="text-center">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-sm btn-default pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close
              <a href="api/surat/mengantar/hapus_surat.php?id=<?php echo $value['id_surat']; ?>&&files=<?php echo $value['files'] ?>">

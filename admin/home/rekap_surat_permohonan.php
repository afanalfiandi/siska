...
<section class="content-header">
  <h1> Rekap Surat Permohonan </h1>
</section>
<!-- Main content -->
<section class="content">
  <a href="surat_permohonan.php" type="button" class="btn btn-danger btn-sm ">
    <i class="fa fa-plus-square"></i> Buat Surat Permohonan</a>
  <p></p>
  <!-- Default box -->
        ...
        <tbody>
          ...
          <?php foreach ($data as $key => $value) { ?>
            <tr>
              ...
              <td>
                <?php echo $value['iduka']; ?>
              </td>
              <td>
                <a href="lihat_surat_permohonan.php?id=<?php echo $value['id_surat']; ?>"><img src="assets/img/folder.png" width="30px" height="30px" alt="" data-toggle="tooltip" data-placement="bottom" title="LIHAT SURAT"> <b>Lihat</b></a>
              </td>
              ...
              <td class="text-center"><span class="label label-success"><i class="fa fa-check"></i> Bersedia</span></td>
              <?php } else { ?>
              <td class="text-center"><span class="label label-danger"><i class="fa fa-remove"></i> Belum / Tidak Bersedia</span></td>
              <?php } ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-sm btn-default pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close
              <a href="api/surat/permohonan/hapus_surat.php?id=<?php echo $value['id_surat']; ?>&&files=<?php echo $value['files']; ?>">

...
<section class="content-header">
    <h1> Halaman Buat Surat Penarikan </h1>
</section>
<!-- Main content -->
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-danger ">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form class="form-horizontal" action="api/surat/menarik/menarik_api.php" method="GET">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" value="Penarikan Praktik Kerja Lapangan" name="hal" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function changeValue(id) {
            document.getElementById('iduka').value = ditIduka[id].id;

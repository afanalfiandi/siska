...
<div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-11 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">Kehadiran Siswa</span>
        </div>
    </div>
    <div class="row">
        <div class="col-lg col-md-6 col-sm-6 mb-4">
            <div class="card card-small mb-4 p-2">
                <div class="card-header border-bottom">
                    <h6 class="m-0">Kehadiran Siswa</h6>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($siswaBimbingan as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="lihat_kehadiran.php?nis=<?php echo $value['nis']; ?>&&nama=<?php echo $value['nama']; ?>">
                                            <?php echo $value['nama']; ?>
                                        </a>
                                    </td>

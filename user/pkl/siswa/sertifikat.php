...
<div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-11 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">Sertifikat</span>
        </div>
                    ...
                    <table class="table mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th scope="col" class="border-0">Tgl Sertifikat </th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $getSertifikat = mysqli_query($conn, "SELECT * FROM sertifikat WHERE nis = '$nis'");
                            foreach ($getSertifikat as $key => $value) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $value['tgl_sertifikat']; ?></td>
                                    <td>
                                        <a href="../../../files/pkl/sertifikat/<?php echo $value['files']; ?>">
                                            Lihat
                                        </a>
                                    </td>
                                </tr>
